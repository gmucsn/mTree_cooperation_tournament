...
class CooperationRandomAgent(Agent):
    """
    This class implements an agent for a prisoner's dilemma simulation which randomly selects its decision.
    """
    def __init__(self):
    ...
    def outcome(self, message: Message):
        ...
        self.log_data("Agent (random) Total Reward now: " + str(self.total_reward))
    ...
    def item_for_bidding(self, message: Message):
        ...
        action_decision = random.choice(decisions)
